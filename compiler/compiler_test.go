...
import (
	...
	"github.com/eiji03aero/monkey/code"
...
func testInstructions(
	...
	if len(actual) != len(concatted) {
		fmt.Errorf("actual has wrong length. want=%q, got=%q", actual, concatted)
	}
...
func testConstants(
	...
	if len(expected) != len(actual) {
		t.Errorf("expected has wrong length. want=%d, got=%d", len(expected), len(actual))
	}
